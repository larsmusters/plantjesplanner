...
export const plantLibrary: Plant[] = [
  {
    ...
    flower: { colour: Colours.green, spriteId: 'bellis_perennis.png', spriteScale: 2 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    name: 'Korenbloem',
    nameLatin: 'Centaureau cyanus',
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'centaurea_cyanus.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    name: 'Groot kaasjeskruid',
    nameLatin: 'Malva sylvestris',
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 10 },
    flower: { colour: Colours.violetFlower, spriteId: 'malva_sylvestris.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    name: 'Hortensia',
    ...
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'hydrangea.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    ...
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'vinca_minor.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    ...
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'cenchrus.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    name: 'Lavendel',
    ...
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'lavandula.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    name: 'Buxus',
    ...
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'buxus.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    ...
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'prunus_lusitanica.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    name: 'Ijzerhard',
    ...
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'verbena_officinalis.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    name: 'Viooltjes',
    ...
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'viola.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    name: 'Geranium',
    ...
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'geranium.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    ...
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'dimorphotheca_ecklonis.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    name: 'Vlinderstruik',
    ...
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'buddleja_davidii.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    name: 'Klimop',
    ...
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'hedera_helix.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    ...
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'trachelospermum_jasminoides.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    name: 'Hartlelie',
    ...
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'hosta.png', spriteScale: 10 }
  },
  {
    ...LIBRARY_PLANT_BASE,
    name: 'Kerstroos',
    ...
    leaf: { colour: Colours.green, spriteId: 'leaf.png', spriteScale: 1 },
    flower: { colour: Colours.blue, spriteId: 'helleborus_niger.png', spriteScale: 10 }
  }
]
